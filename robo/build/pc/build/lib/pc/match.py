...
def main():
    # Paths to the files
    positions_file = '/home/vatsan/robo/src/ros2_learners/logs/list.json'  # Update with your positions file path
    labels_file = '/home/vatsan/robo/src/ros2_learners/logs/PromtObject.json'  # Update with your classification labels file path
    output_file = '/home/vatsan/robo/src/ros2_learners/logs/TaskObjectLocation.json'  # Path to save the output JSON file
