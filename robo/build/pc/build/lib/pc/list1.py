...
class DataLogger(Node):
    def __init__(self):
        ...
        self.file_path = '/home/vatsan/robo/src/ros2_learners/logs/list.json'
    ...
    def odom_callback(self, msg):
        ...
        if self.classification_data is not None and self.classification_data != "67":
            ...
            self.get_logger().info("Predicted class is 67, not storing odometry data.")
